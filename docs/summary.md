...
- Структура репозитория: исходного приложения нет, есть требования, дизайн и итоговые документы.

Отсутствующие входные данные:

- отдельные папки `uikit/`, `mockups/`, `assets/`, `assets/ui`;
- исходный frontend/backend код;
- схемы БД, API-контракты, тесты;
...
- React 19.
- TypeScript.
- Tailwind with project design tokens.
- PostgreSQL 18.
- Meilisearch.
